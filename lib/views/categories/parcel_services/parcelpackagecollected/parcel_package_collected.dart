...
class ParcelPackageCollected extends StatefulWidget {
  const ParcelPackageCollected({super.key});

  @override
  State<ParcelPackageCollected> createState() => _ParcelPackageCollectedState();
}

class _ParcelPackageCollectedState extends State<ParcelPackageCollected> {
  bool isCancel = true;
  @override
