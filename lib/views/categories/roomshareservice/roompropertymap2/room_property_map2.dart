...
import 'package:joyapp/views/categories/roomshareservice/roompropertyplantour/room_property_plan_tour.dart';
...
class RoomPropertyMap2 extends StatefulWidget {
  const RoomPropertyMap2({super.key});

  @override
  State<RoomPropertyMap2> createState() => _RoomPropertyMap2State();
}

class _RoomPropertyMap2State extends State<RoomPropertyMap2> {
