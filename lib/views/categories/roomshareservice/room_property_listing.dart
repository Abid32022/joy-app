...
import 'package:joyapp/views/categories/roomshareservice/roompropertydetail/room_property_detail.dart';
import 'package:joyapp/views/categories/roomshareservice/roompropertylisting/base/room_property_type.dart';
import 'package:joyapp/views/categories/roomshareservice/roompropertymap/room_property_map.dart';
import 'package:joyapp/views/categories/sell&rent/propertydetail/property_detail.dart';
class RoomPropertyListing extends StatefulWidget {
  const RoomPropertyListing({Key? key}) : super(key: key);

  @override
  State<RoomPropertyListing> createState() => _RoomPropertyListingState();
}

class _RoomPropertyListingState extends State<RoomPropertyListing> {
