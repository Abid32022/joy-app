...
class RoomPropertyReviews extends StatelessWidget {
  const RoomPropertyReviews({super.key});
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              return Padding(
                ...
                child: Container(
                  width: MySize.scaleFactorWidth * 315,
                  ...
                  child: Padding(
                    padding: EdgeInsets.symmetric(
                        ...
                        vertical: MySize.scaleFactorHeight * 16),
                    child: Column(
