...
class RoomPropertyView extends StatefulWidget {
  ...
  const RoomPropertyView({super.key,    required this.imageUrl,
    required this.title,
  ...
  @override
  State<RoomPropertyView> createState() => _RoomPropertyViewState();
}

class _RoomPropertyViewState extends State<RoomPropertyView> {
  @override
