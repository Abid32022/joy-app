...
class RoomPropertyMap extends StatefulWidget {
  const RoomPropertyMap({super.key});

  @override
  State<RoomPropertyMap> createState() => _RoomPropertyMapState();
}

class _RoomPropertyMapState extends State<RoomPropertyMap> {
  @override
