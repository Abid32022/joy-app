...
import 'package:joyapp/views/categories/hotelservice/hotelplacecalender/hotel_place_calender.dart';
import 'package:joyapp/views/categories/hotelservice/hotelplacedetail/base/hotel_place_entire_rental.dart';
import 'package:joyapp/views/categories/hotelservice/hotelplacedetail/base/hotel_place_reviews.dart';
import 'package:joyapp/views/categories/hotelservice/hotelplacedetail/base/hotel_place_view.dart';
class HotelPlaceDetail extends StatefulWidget {
  const HotelPlaceDetail({super.key});

  @override
  State<HotelPlaceDetail> createState() => _HotelPlaceDetailState();
}

class _HotelPlaceDetailState extends State<HotelPlaceDetail> {
  List rewardList = [
            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    customTextRegular(
                      title: "Show all 30 annoucements",
                      decoration: TextDecoration.underline,
                      fontSize: MySize.size16,
                      fontWeight: FontWeight.w400,
                    ),
