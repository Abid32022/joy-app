...
class HotelPlaceView extends StatefulWidget {
  ...
  const HotelPlaceView({super.key,
  ...
  @override
  State<HotelPlaceView> createState() => _HotelPlaceViewState();
}

class _HotelPlaceViewState extends State<HotelPlaceView> {
  @override
