...
class HotelPlaceMap extends StatefulWidget {
  const HotelPlaceMap({super.key});

  @override
  State<HotelPlaceMap> createState() => _HotelPlaceMapState();
}

class _HotelPlaceMapState extends State<HotelPlaceMap> {
  @override
