...
class MedicalDoctorTab extends StatefulWidget {
  const MedicalDoctorTab({super.key});

  @override
  State<MedicalDoctorTab> createState() => _MedicalDoctorTabState();
}

class _MedicalDoctorTabState extends State<MedicalDoctorTab> {
  @override
