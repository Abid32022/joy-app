...
import 'package:joyapp/views/categories/make_apporientments/medicaldoctor/base/medical_doctor_tab.dart';
class MedicalDoctor extends StatefulWidget {
  const MedicalDoctor({super.key});

  @override
  State<MedicalDoctor> createState() => _MedicalDoctorState();
}

class _MedicalDoctorState extends State<MedicalDoctor> with TickerProviderStateMixin {
